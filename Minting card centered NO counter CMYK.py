...
# --- START FIX: Manually reduce Magenta ---
        ...
        dpi = 300 # Ensure DPI is defined for saving
...
if __name__ == "__main__":
    ...
    output_pdf_path = 'cards_layout_No_Counter_CMYK.pdf'
    base_filename = 'merged_image'
    font_size = 25
    counter_font_size = 20 # Font size for the (now disabled) counter
